...
export function Button({
  ...
  const base = "flex-row items-center justify-center rounded-2xl py-4 active:opacity-80";
  const variants = {
    ...
    >
      {loading ? (
        ...
        <View className="flex-row items-center">
          ...
          <Text className={`text-base font-semibold ${textVariants[variant]} ${Icon ? "ml-2" : ""}`}>
            {label}
          </Text>
        </View>
      )}
